    ...
    <div class="page-banner__wrapper">
        <div class="container">
            ...
            <div class="page-banner__caption text-center">
                <h2 class="page-banner__main-title card p-5"><?=Yii::t('main','albums')?></h2>
            </div>
    ...
    <div class="container">
        ...
        <div class="page-breadcrumb mb-15">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><?=Yii::t('main','albums')?></li>
            </ul>
        </div>
        <!-- Page Breadcrumb End -->
                    ...
                    <?php if(!empty($models)): ?>
                        ...
                        <?php foreach ($models as $model): ?>
                            ...
                            <?php if($model->getLang('id')): ?>
                                ...
                                <?php $image = \common\models\Image::find()->where(['album' => $model->id, 'status' => 1])->orderBy(['id' => SORT_DESC])->one() ?>
                                <?php $image = \common\components\StaticFunctions::getImage($image,'album','guid') ?>
                                ...
                                <div class="col-md-6 col-xl-4 grid-item">
                                    ...
                                    <div class="blog-item-02" data-aos="fade-up" data-aos-duration="1000">
                                        <div class="blog-item-02__image">
                                            <a href="<?=\yii\helpers\Url::to(['album/view','id' => $model->id])?>"><img src="<?=$image?>" alt="Blog" width="370" height="201"></a>
                                        </div>
                                        <div class="blog-item-02__content">
                                            ...
                                            <h3 class="blog-item-02__title"><a href="<?=\yii\helpers\Url::to(['album/view','id' => $model->id])?>"><?=$model->getLang('name')?></a></h3>

                                            <a class="blog-item-02__more btn btn-light btn-hover-white" href="<?=\yii\helpers\Url::to(['albumalbum/view','id' => $model->id])?>"><?=Yii::t('main','read-more')?> <i class="fal fa-long-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <!-- Blog Item End -->
