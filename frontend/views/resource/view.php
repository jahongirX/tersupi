...
$this->title = \common\components\StaticFunctions::getSettings('title') . " - " . \common\models\ResourceCategory::findOne($model->category_id)->getLang('name') . "-" . $model->getLang('title');
    ...
    <div class="container">
        ...
        <div class="page-breadcrumb mb-15">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="<?=yii\helpers\Url::to(['resource/category','id' => $model->category_id])?>"> <?=\common\models\ResourceCategory::findOne($model->category_id)->getLang('name')?></a></li>
